...
namespace Galador.ExcelGrid.Helpers
{
    ...
    {
        /// <summary>
        /// Filters on the <see cref="System.ComponentModel.BrowsableAttribute" /> and <see cref="Galador.ExcelGrid.DataAnnotations.BrowsableAttribute" />.
        /// </summary>
        ...
        public static List<object> FilterOnBrowsableAttribute<T>(this T arr) where T : IEnumerable
        {
            ...
            foreach (var o in arr)
            {
                ...
                if (field != null)
                {
                    ...
                    var browsable2 = field.GetCustomAttributes<BrowsableAttribute>(true).FirstOrDefault();
                    if (browsable2 != null)
                    {
                        // It is declared, is it true or false?
