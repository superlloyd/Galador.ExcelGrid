...
namespace Galador.ExcelGrid.Operators
{
    ...
    public abstract class DataGridOperator : IDataGridOperator
    {
        ...
        /// </summary>
        private readonly Dictionary<Definitions.PropertyDefinition, PropertyDescriptor> descriptors = new Dictionary<Definitions.PropertyDefinition, PropertyDescriptor>();
        ...
        /// </returns>
        public virtual Type GetPropertyType(Definitions.PropertyDefinition definition, CellRef cell, object currentValue)
        {
        ...
        /// </returns>
        protected virtual PropertyDescriptor GetPropertyDescriptor(Definitions.PropertyDefinition pd, object item, CellRef? cell)
        {
        ...
        public virtual Definitions.PropertyDefinition GetPropertyDefinition(CellRef cell)
        {
        ...
        protected virtual void SetPropertiesFromDescriptor(Definitions.PropertyDefinition pd, PropertyDescriptor descriptor)
        {
            if (descriptor == null)
            {
                return;
            ...
            if (descriptor.GetAttributeValue<System.ComponentModel.ReadOnlyAttribute, bool>(a => a.IsReadOnly)
                || descriptor.GetAttributeValue<ReadOnlyAttribute, bool>(a => a.IsReadOnly)
        ...
        protected abstract IEnumerable<Definitions.ColumnDefinition> GenerateColumnDefinitions(IList list);
