...
namespace Galador.ExcelGrid.Operators
{
    ...
    public class ListOperator : DataGridOperator
    {
        ...
        protected override IEnumerable<Definitions.ColumnDefinition> GenerateColumnDefinitions(IList list)
        {
            if (list == null)
            {
                yield break;
            ...
            if (itemPropertiesView?.ItemProperties != null && itemPropertiesView.ItemProperties.Count > 0)
            {
                foreach (var info in itemPropertiesView.ItemProperties)
                {
                    ...
                    var cd = new Definitions.ColumnDefinition
                    {
            ...
            yield return
                new Definitions.ColumnDefinition
                {
